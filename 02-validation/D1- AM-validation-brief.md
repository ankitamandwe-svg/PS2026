...
The data is all there, but users can't find the insight and its too much information, so they bounce.

## Hypothesis

> We believe **a first screen that leads with one headline metric, a plain-language takeaway, and one recommended action** will cause **users act on the dashboard, its interactive instead of bouncing** for **the people who should make decisions from it - Growth, Sales, Product teams**. We'll know we're right when **bounce rate drops, higher engagement and the recommended action gets clicked**.
